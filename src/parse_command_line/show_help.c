...
/*   Updated: 2019/08/25 17:23:39 by mdovhopo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	show_help(t_gl_env *env, t_obj *obj, int *curr_arg, char *parm_name) 
{
	...
	ft_printf("\t--color <hex color code> - specify color for object (#ff00ff)\n");
	ft_printf("\t--window-name <name> - specify window name\n");
	ft_printf("\t--window-size <width>x<height> - specify screen size (1600x900)\n"RESET);
	exit(1);
}
